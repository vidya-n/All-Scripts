...
class Nchdoctors(BaseScript):
    ...
    def process_data(self):
        base_url = 'https://nchmd.org/providers/'
        url = 'https://code.metalocator.com/index.php?option=com_locator&view=directory&layout=combined_bootstrap&Itemid=17383&tmpl=component&framed=1&source=js'
        count = 1
        profiles = []
        ...
        while True:
            print("test")
            page_count = count
            elements = self.driver.find_elements(By.XPATH, '//a[contains(@class, "ml_staticlink")]')
            if elements:
                for i in elements:
            ...
            try:
                self.driver.find_element(By.XPATH, '//li[contains(@class, "next-page")]/a').click()
                time.sleep(5)
