...
class Texashealth(BaseScript):
    
    def process_data(self):
        profiles = []
        print("hitting the url")
        base_url = 'https://www.care.texashealth.org'
        page_count = 1
        offset = 0
        while page_count <= 531:
            print("test")
            url = f'https://womphealthapi.azurewebsites.net/api/OmniSearch?skip={offset}%2C0&top=20&cid=843329c2-3e96-4af1-8164-bd0f765becbc&latitude=30.3132392&longitude=76.375877&time=any&inferLocationFromSearch=false&locations=false&type=search&brand=thr'
            headers = {
                'Accept': '*/*',
                'Accept-Encoding': 'gzip, deflate, br, zstd',
                'Accept-Language': 'en-US,en;q=0.9',
                'Referer': 'https://www.care.texashealth.org/',
